        ...
        return(
            <div className='home transition-item'>
                ...
                <div className='card-section container'>
                    <div className='row'>
                        <Card col={'col-md-4'} icon={<ShoppingCart />} title={'Buy Art'} sentence={'Look for and buy new abstract doodles. Search through the categories to find your perfect doodle'} idx={300}/>
                        <Card col={'col-md-4'} icon={<Notes />} title={'Pricing'} sentence={'Look at how the art is priced. It mainly depends on how much time the art takes to complete'} idx={400}/>
                        <Card col={'col-md-4'} icon={<Information />} title={'About'} sentence={'Find out about Tina Clarke. What drives her to make fantastic art. How she goes about completing a doodle'} idx={500}/>
                        <Card col={'col-md-4'} icon={<Blog />} title={'Blog'} sentence={'What to learn more about how Tina makes doodles and cool topics to improve your skills? take a look at her blog'} idx={100}/>
